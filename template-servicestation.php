<?php
/**
 * Template Name: Template for Service Station Page
 */
get_header();
?>
<div class="services_item brockerage  col-xs-12 col-sm-6 col-md-4">
  <a href="#" class="well_modal" role="button">
  <div class="well">
    ...
    <h3 class="well__header text-center">СТО</h3>

    <p class="text text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus error ipsam dolorem possimus, quae dolor reiciendis quia, quo praesentium libero ea tenetur, doloribus fuga doloremque ab quam magni impedit! Fuga.</p>
